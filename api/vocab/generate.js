  ...
  try {
    const response = await fetch('https://api.groq.com/openai/v1/chat/completions', {
      ...
      body: JSON.stringify({
        ...
        messages: [{
          role: 'user',
          content: `Generate 5 English vocabulary words for a ${level} learner. Theme: ${theme}. Return ONLY valid JSON, no markdown, no extra text: {"words":[{"word":"","phonetic":"","type":"","meaning":"","example":"","tamil_meaning":""}]}`
        }]
      })
    });
